...
public class Jeopardy implements ActionListener {
	 ...
	 */
	JButton small = new JButton("200");
	JButton medium = new JButton("400");
	JButton middle = new JButton("600");
	JButton sortalarge = new JButton("800");
	JButton large = new JButton("1000");
	
	private JButton createButton(String dollarAmount) {
		// Create a new JButton
		JButton name = new JButton();
		// Set the text of the button to the dollarAmount
		name.setText(dollarAmount);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(buttonPressed == firstButton) {
			askQuestion("Who is Kara Thrace?", "The best character on Battlestar Galactica.", 2500);
			firstButton.setText("");
		}
		...
		// Or if the buttonPressed was the secondButton
			...
			askQuestion("Who is Demi Lovato?", "The best singer ever.", 2500);
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		question = JOptionPane.showInputDialog(question);
